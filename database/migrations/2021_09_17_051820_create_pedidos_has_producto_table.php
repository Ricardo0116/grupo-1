...
class CreatePedidosHasProductoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pedidos_has_producto', function (Blueprint $table) {
            // $table->id();
    ...
    {
        Schema::dropIfExists('pedidos_has_producto');
    }
}
