				...
				<div class="block">
					...
					<div class="content text-center">
						...
						<form action="#" id="myForm">
							...
							<input for="pass" class="form-control main" type="password" placeholder="Password" id="pass" class="contraseña" pattern="[A-Za-z0-9]{5,8}" required>
							</div>
							
							<!-- Submit Button -->
							<a href="{{url('http://proyecto-sicv.herokuapp.com/public/index')}}" type="button" class="btn btn-danger ">CANCELAR </a>
