    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="index.html">Home
        ...
        <li class="nav-item dropdown @@pages">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="index/login">Iniciar Sesión</a></li>
	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="images/campo.jpg" alt="screenshot">
			</div>
		</div>
	</div>
</section>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
          <div class="block-2">
            ...
            <!-- links -->
            <ul>
              <li><a href="">Areuipes</a></li>
              <li><a href="">Yoguths</a></li>
              <li><a href="">Manjar Blanco</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
        ...
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
          <div class="block-2">
            ...
            <!-- links -->
            <ul>
              <li><a href="sign-in.html">Inicio de Sesión</a></li>
